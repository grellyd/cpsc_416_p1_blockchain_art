...
func TestOpToString(t *testing.T) {
	...
	ExpectEquals(t, s, "<svg><circle cx=\"10\" cy = \"6\" r = \"1\" stroke=\"red\" fill =\"transparent\"/></svg>")
	...
	ExpectEquals(t, s, "<svg><path d=\"M5,2L6,2L6,3L5,3L5,2\" stroke=\"red\" fill =\"transparent\"/></svg>")
}